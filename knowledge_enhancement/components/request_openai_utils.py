...
class OpenAIModel:
    ...
    def chat_generate(self, client, input_string, temperature = 0.0):
    ...
    def get_logprobs(self, client, input_string, temperature=0.0):
        response = completions_with_backoff(
            client,
            model=self.model_name,
            messages=[
    ...
    def logprobs_generate(self, client, input_string, temperature=0.0):
        return self.get_logprobs(client, input_string, temperature)